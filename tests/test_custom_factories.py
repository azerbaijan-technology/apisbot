...
class TestCustomFactories:
    ...
    def test_create_natal_chart_data_restricted(self, mock_cast, mock_aspects_factory, mock_base_factory, mock_single_model_class):
        ...
        # Execute
        result = CustomChartDataFactory.create_natal_chart_data(
    ...
    def test_create_natal_chart_data_unrestricted(self, mock_base_factory):
        ...
        mock_subject = MagicMock()
        CustomChartDataFactory.create_natal_chart_data(
            subject=mock_subject,
            restrict_to_similar_signs=False
        )
        mock_base_factory.create_natal_chart_data.assert_called_once()
    ...
    def test_single_chart_aspects(self, mock_get_points, mock_get_aspect, mock_aspect_model, mock_single_aspects_model):
        ...
        result = CustomAspectsFactory.single_chart_aspects(mock_subject)
    ...
    @patch("apisbot.services.custom_aspects_factory.get_aspect_from_two_points_with_signs")
    @patch("apisbot.services.custom_aspects_factory.get_active_points_list")
    def test_single_chart_aspects_no_aspect(self, mock_get_points, mock_get_aspect, mock_aspect_model, mock_single_aspects_model):
